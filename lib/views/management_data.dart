    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          CustomText(
            text: '${apiResult?.principalInvestigators?.first.primaryEmail} ',
            textAlign: TextAlign.start,
            color: Colors.blue,
            fontSize: 17,
            fontWeight: FontWeight.w400,
          ...
          for (int i = 0; i < apiResult!.projectManagers!.length; i++)
            CustomContainer(
                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: CustomText(
                        text:
                            'Contact Id : ${apiResult.projectManagers![i].contactId}',
                        color: Colors.blue,
                        fontSize: 14,
                        fontWeight: FontWeight.w400,
                      ),
                    ...
                    CustomText(
                      text: '${apiResult.projectManagers![i].fullName}',
                      color: Colors.grey.shade600,
                      fontSize: 17,
                      fontWeight: FontWeight.w400,
                    ),
                    CustomText(
                      text: '${apiResult.projectManagers![i].primaryEmail}',
                      color: Colors.blue,
                      fontSize: 15,
                      fontWeight: FontWeight.w400,
                    ),
